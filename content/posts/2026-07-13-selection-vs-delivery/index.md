...
faq:
  - q: "实验平台选型阶段最容易踩的坑是什么？"
    a: "最大坑是止步于选型：只比功能清单和报价，忽略了实验科学本身的成熟度（流量分层、随机化单元、显著性判定、护栏指标）。平台买来了，组织不会用，结果不可信，推全就反转。"
  - q: "咨询顾问在实验平台项目里到底补什么？"
    a: "补选型与交付两端的专家指引：选型侧帮你在采购/自建/共建之间做判断并定边界；交付侧重在把平台落到业务里跑出可信结论，而不是替研发写代码或卖某个 SaaS。"
  - q: "自建实验平台和采购 SaaS 怎么选？"
    a: "取决于流量主权、工程带宽与迭代节奏。若业务对实验依赖深且流量场景复杂，共建或自建更可控；若仅起步验证，成熟 SaaS 更快。关键是在选型前先想清楚实验体系和组织能力，而不是先比价。"
---
